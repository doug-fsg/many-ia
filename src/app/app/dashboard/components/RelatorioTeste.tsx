    ...
    <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
      ...
      <Card className="sm:col-span-2">
        <CardHeader>
          ...
          <CardDescription>Total de créditos gastos pela IA no mês</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{creditoGastoMes}</p>
          <Progress value={porcentagemCreditoMes} aria-label={`Créditos gastos no mês`} />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Total de créditos gastos pela IA na semana</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{creditoGastoSemana}</p>
          <Progress value={porcentagemCreditoSemana} aria-label={`Créditos gastos na semana`} />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Quanto ainda resta de crédito disponível</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-3xl font-bold">{creditoRestante}</p>
          <Progress value={porcentagemCreditoRestante} aria-label={`Restam ${creditoRestante} de crédito`} />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Total de contatos feitos pela IA na semana</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Total de contatos feitos pela IA no mês</CardDescription>
        </CardHeader>
        <CardContent>
